...
[300, 400]
# 组1，cluster 3，聚类中心是 (400, 500)
[400, 500]
[500, 600]
# 组2，cluster 0，聚类中心是 (100, 100)
[100, 100]
# 组2，cluster 1，聚类中心是 (200, 500)
[200, 500]
[300, 400]
...
5 个 tar 共 41330 个图片，使用 [ResNet50](https://arxiv.org/abs/1512.03385) 提取特征。这里因为使用的数据集较少就不做 PCA 降维了，直接
...
|--------------------|---------|------|--------|-------|------|------|
| brute_force_search | 0.07s   | 323M | 
| hnsw8              | 1.57s   | 326M |
| hnsw64             | 204.10s | 344M |
| ivf128             | 0.43s   | 331M |
| ivf1024            | 1.53s   | 324M |
| hnsw8_pq16         | 10.57s  | 5.8M |
| hnsw8_pq64         | 39.13s  | 7.7M |
| ivf128_pq16        | 10.55s  | 3.9M |
| ivf128_pq64        | 38.52s  | 5.8M |
